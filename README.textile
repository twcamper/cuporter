...
h3. Dozens of Languages

Whatever spoken language your installed of version "Gherkin":http://github.com/cucumber/gherkin supports.  @gherkin/i18n.yml@ currently lists about 45.  As in Cucumber itself, @en@ is the default, overridden in the presence of @#language: <iso-code>@ on line 1 of the feature file.
