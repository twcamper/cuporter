...
Feature: output a report in multiple formats
  ...
  Scenario: four formats four output files all exist
    ...
    When I run cuporter -i fixtures/self_test -f html -f csv -f text -f xml -o tmp/tags.csv -o tmp/tags.txt -o tmp/tags.xml -o tmp/tags.html
